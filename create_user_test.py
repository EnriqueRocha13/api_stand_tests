...
#Está función cambia los valores en el parametro "First Name"
def get_user_body(first_name):
    ...
    #Se cambia el valor del parametro firstName
...
def test_create_user_2_letter_in_first_name_get_success_response():
    ...
    user_body = get_user_body("Aa")#Uso de la función anterior
    # El resultado de la solicitud relevante se guarda en la variable "user_response"
    user_response = sender_stand_request.post_new_user(user_body)

    # ESTAS LÍNEAS HACEN LA MAGIA:
    print(user_response.status_code)  # Esto imprimirá el 201
    print(user_response.json())  # Esto imprimirá el diccionario con el authToken
...
# Función de prueba negativa 8 https://tripleten.com/trainer/qa-engineer/lesson/88eadfc9-0bfb-4cbb-92f4-725ecf9f8ad9/
